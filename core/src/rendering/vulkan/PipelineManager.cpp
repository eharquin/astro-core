...
namespace Core::Rendering::Vulkan {
	...
	void PipelineManager::createPipeline(const std::string &name, const std::string &filePath,
		...
		const vk::raii::ShaderModule shaderModule = createShaderModule(device, Utils::readFile(filePath));
